...
public class ReportesAvanzadosViewController {

    @FXML private TableView<Transaccion> tablaReportes;
    ...
    private final BancoData data = BancoData.getInstancia();
    ...
    public void initialize() {
        try {
            ...
            // 👉 Conexión: misma lista observable que usa MonitoreoTransacciones
            tablaReportes.setItems(data.getListaTransacciones());
        } catch (Exception e) {
            e.printStackTrace();
        }
    }

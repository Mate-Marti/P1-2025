...
import java.util.Date; // Se añade import para Date
...
public class BancoData {
    ...
    private ObservableList<Transaccion> listaTransaccionesObservable; // Nuevo campo
    ...
    private BancoData() {
        ...
        this.listaTransaccionesObservable = FXCollections.observableArrayList(banco.getTransacciones()); // Inicialización
    }
